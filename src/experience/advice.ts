...
export const ADVICE: Record<string, IndicatorContextEntry> = {
  econ_02_grocery_cpi: {
    whatItMeans: {
  ...
  housing_04_rent_cpi: {
    whatItMeans: {
      amber: 'Rents are rising faster than usual compared with a year ago.',
      red: 'Rents are rising very fast, close to the 2023 peak.',
    },
    familyImpact: {
      amber: 'Expect a bigger increase at your next lease renewal.',
      red: 'Lease renewals may come with steep increases, and cheaper places get scarce.',
    },
    whatToDo: {
      amber: 'Check your lease end date and start looking at what similar places rent for nearby.',
      red: 'Talk to your landlord early about renewal terms, and call a free housing counselor if the numbers don’t work.',
    },
    dataPointLabel: 'Rent vs a year ago',
    source: 'BLS Consumer Price Index',
    peripheralImpacts: ['Moving costs', 'Security deposits'],
  },

  energy_03_electricity_cpi: {
    whatItMeans: {
      amber: 'Electricity prices are up noticeably from a year ago.',
      red: 'Electricity prices are rising very fast, near the 2022 spike.',
    },
    familyImpact: {
      amber: 'Your monthly electric bill is likely higher than last year.',
      red: 'Electric bills are a real strain; falling behind can lead to shutoff notices.',
    },
    whatToDo: {
      amber: 'Ask your utility about budget billing so the bill stays the same each month.',
      red: 'Apply for heating and cooling help (LIHEAP) and ask your utility about payment plans before you fall behind.',
    },
    dataPointLabel: 'Electricity vs a year ago',
    source: 'BLS Consumer Price Index',
    peripheralImpacts: ['Cooling and heating costs'],
  },

  cost_auto_insurance: {
    whatItMeans: {
      amber: 'Car insurance prices are up sharply from a year ago.',
      red: 'Car insurance prices are rising at a near-record pace.',
    },
    familyImpact: {
      amber: 'Expect a higher premium at your next renewal.',
      red: 'Renewals may jump a lot; that’s money out of every paycheck for anyone who drives to work.',
    },
    whatToDo: {
      amber: 'Get two or three quotes before your policy renews; switching often saves money.',
      red: 'Shop quotes now and ask about higher deductibles or usage-based discounts.',
    },
    dataPointLabel: 'Car insurance vs a year ago',
    source: 'BLS Consumer Price Index',
    peripheralImpacts: [],
  },
  ...
  cost_childcare: {
    whatItMeans: {
      amber: 'Day care and preschool prices are rising faster than usual.',
      red: 'Childcare prices are rising at a record pace.',
    },
    familyImpact: {
      amber: 'Childcare may cost more at your next enrollment or renewal.',
      red: 'Higher childcare costs can make working hours harder to cover.',
    },
    whatToDo: {
      amber: 'Ask your provider about any planned increases and check if your employer has a dependent care account.',
      red: 'Check your state’s childcare assistance through 211, and use a dependent care account if your job offers one.',
    },
    dataPointLabel: 'Childcare vs a year ago',
    source: 'BLS Consumer Price Index',
    peripheralImpacts: [],
  },

  job_02_continuing_claims: {
    whatItMeans: {
      amber: 'More people are staying on unemployment longer, so jobs are harder to find.',
      red: 'Finding a new job is taking much longer than usual.',
    },
    familyImpact: {
      amber: 'If you lost work, it could take longer to replace the income.',
      red: 'A job loss now could mean months without a paycheck.',
    },
    whatToDo: {
      amber: 'Build toward three months of expenses and keep your resume current.',
      red: 'Know how to file for unemployment in your state, and pause big new debts.',
    },
    dataPointLabel: 'People still on unemployment',
    source: 'Dept. of Labor via FRED',
    peripheralImpacts: [],
  },
  ...
  job_03_real_wages: {
    whatItMeans: {
      amber: 'Typical paychecks are falling behind rising prices.',
      red: 'Paychecks are losing ground to prices quickly.',
    },
    familyImpact: {
      amber: 'The same paycheck buys a little less than last year.',
      red: 'Real income is shrinking; budgets that worked last year may not now.',
    },
    whatToDo: {
      amber: 'Check you’re getting every credit you qualify for, like the earned income tax credit.',
      red: 'Review your budget for the biggest bills, and check benefits like SNAP and Lifeline you may now qualify for.',
    },
    dataPointLabel: 'Pay vs prices, a year apart',
    source: 'BLS via FRED',
    peripheralImpacts: [],
  },
  ...
  job_04_sahm_rule: {
    whatItMeans: {
      amber: 'Unemployment is starting to rise above its recent low.',
      red: 'Unemployment has risen enough that a recession has usually already begun.',
    },
    familyImpact: {
      amber: 'Hiring may slow over the coming months.',
      red: 'Layoffs tend to spread across industries during recessions.',
    },
    whatToDo: {
      amber: 'Put a little more into savings each paycheck while you can.',
      red: 'Aim for several months of expenses in cash and hold off on big new debt.',
    },
    dataPointLabel: 'Sahm rule',
    source: 'Federal Reserve via FRED',
    peripheralImpacts: [],
  },

  debt_01_card_delinquency: {
    whatItMeans: {
      amber: 'More families are falling behind on credit card payments.',
      red: 'Credit card late payments are at levels last seen in serious downturns.',
    },
    familyImpact: {
      amber: 'Banks may tighten credit limits and approvals.',
      red: 'Credit gets harder to get just when people need it most.',
    },
    whatToDo: {
      amber: 'Pay more than the minimum on your highest-rate card, and don’t rely on cards as your emergency fund.',
      red: 'If payments are slipping, call your card company before you miss one, or talk to a free credit counselor.',
    },
    dataPointLabel: 'Card balances 30+ days late',
    source: 'Federal Reserve via FRED',
    peripheralImpacts: [],
  },
  ...
  bio_02_wastewater: {
    whatItMeans: {
      amber: 'Virus levels in sewage are high in many places, so a wave of illness is likely.',
      red: 'Virus levels are high across most of the country.',
    },
    familyImpact: {
      amber: 'Sick days and school absences are more likely in the coming weeks.',
      red: 'Expect a lot of illness at work and school; plan for missed days.',
    },
    whatToDo: {
      amber: 'Restock fever reducer, tests and tissues, and check you’re up to date on vaccines.',
      red: 'Line up backup childcare and know your sick-leave options before someone gets sick.',
    },
    dataPointLabel: 'People in high virus areas',
    source: 'CDC',
    peripheralImpacts: [],
  },
};

export function getAdvice(indicatorId: string): IndicatorContextEntry | null {
  return ADVICE[indicatorId] ?? null;
}
